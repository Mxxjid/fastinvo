...
import { ArrowRight, FileText, Calendar, Trash2, Hash } from 'lucide-react';
...
const HistoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 pb-10 font-sans selection:bg-blue-500/30" dir="rtl">
      
      {/* Header - هماهنگ با بقیه صفحات */}
        ...
        {invoices.length === 0 ? (
          <div className="text-center py-32 space-y-6">
            ...
            <div className="space-y-2">
                <p className="text-gray-400 font-bold text-xl">فاکتوری یافت نشد</p>
                <p className="text-gray-600 text-sm">شما هنوز هیچ فاکتوری در سیستم ثبت نکرده‌اید.</p>
            </div>
            <button 
          ...
          <div className="space-y-4">
            {invoices.map((inv) => (
              ...
              >
                {/* بخش بالایی کارت: اطلاعات مشتری و آیکون */}
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-3 text-[10px] text-gray-500 font-bold">
                        ...
                        <span className="flex items-center gap-1"><Hash size={12}/> {inv.number}</span>
                      </div>
                    </div>
                  </div>
      ...
      {/* استایل کمکی برای جلوگیری از Horizontal Scroll احتمالی */}
      <style>{`
